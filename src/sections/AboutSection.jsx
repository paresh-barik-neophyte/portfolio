...
const AboutSection = () => {
  ...
  return (
    <section
      id="about"
      ref={sectionRef}
      className="py-24 bg-gradient-to-br from-purple-50 via-white to-emerald-50 dark:from-purple-900/20 dark:via-slate-900 dark:to-emerald-900/20"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div ref={titleRef} className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            I bring a unique combination of technical expertise, leadership
            experience, and passion for creating exceptional digital experiences
            that drive business success and exceed expectations.
          </p>
        </div>
        ...
        >
          {whyHireMe.map((item, index) => {
            ...
            return (
              <div key={index} className="about-card group relative">
                {/* Card */}
                <div className="relative bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-lg hover:shadow-2xl border border-slate-200 dark:border-slate-700 transition-all duration-500 hover:-translate-y-4 cursor-hover h-full overflow-hidden">
                  {/* Background Gradient */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${gradients[index]} opacity-5 group-hover:opacity-10 transition-opacity duration-500`}
                  ></div>
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start space-x-6">
                      <div className="flex-shrink-0">
                        <div
                          className={`w-16 h-16 bg-gradient-to-br ${gradients[index]} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}
                        >
                          {IconComponent && (
                  ...
                  <div className="absolute top-4 right-4 opacity-20 group-hover:opacity-30 transition-opacity duration-300">
                    <div
                      className={`w-32 h-32 bg-gradient-to-br ${gradients[index]} rounded-full blur-2xl`}
                    ></div>
                  </div>

                  <div className="absolute -bottom-4 -right-4 opacity-10 group-hover:opacity-20 transition-opacity duration-300">
                    <div
                      className={`w-24 h-24 bg-gradient-to-tl ${gradients[index]} rounded-full blur-xl`}
                    ></div>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-emerald-600 rounded-3xl p-8 lg:p-12 shadow-2xl">
          <div className="text-center mb-12">
            ...
            <p className="text-blue-100 text-lg max-w-2xl mx-auto">
              Numbers that speak for themselves - consistent delivery and
              exceptional results
            </p>
          </div>
