...
const SkillsSection = () => {
  ...
  return (
    <section
      id="skills"
      ref={sectionRef}
      className="py-24 bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-indigo-900/20 dark:via-slate-900 dark:to-cyan-900/20"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div ref={titleRef} className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-primary leading-tight mb-6">
            Skills &<span className="text-gradient block">Expertise</span>
          </h2>

          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            A comprehensive toolkit of modern technologies, frameworks, and
            leadership skills to build scalable, performant applications and
            lead successful development teams.
          </p>
        </div>
            ...
            return (
              <div key={section.id} className="expertise-section">
                ...
                <button
                  ...
                  className={`w-full text-left bg-white dark:bg-slate-800 p-6 lg:p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-200 dark:border-slate-700 group ${
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-6">
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${section.gradient} rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
                    ...
                    <div
                      className={`w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-r ${
                        section.gradient
                  ...
                  <div className="bg-white dark:bg-slate-800 rounded-b-2xl p-6 lg:p-8 border-x border-b border-slate-200 dark:border-slate-700">
                    <div className="flex flex-wrap gap-4">
                      {section.items.map((item, idx) => (
                        <div
                          key={idx}
                          className="inline-flex items-center space-x-3 bg-slate-100 dark:bg-slate-700/50 px-4 py-2 rounded-lg"
                        >
                          <div
                            className={`w-2.5 h-2.5 bg-gradient-to-r ${section.gradient} rounded-full`}
                          ></div>
        ...
        <div className="mt-20 bg-gradient-to-r from-indigo-600 via-purple-600 to-cyan-600 rounded-3xl p-8 lg:p-12 shadow-2xl">
          <div className="text-center mb-12">
            ...
            <p className="text-indigo-100 text-lg max-w-2xl mx-auto">
              Years of experience and dedication to continuous learning and
              improvement
            </p>
          </div>
